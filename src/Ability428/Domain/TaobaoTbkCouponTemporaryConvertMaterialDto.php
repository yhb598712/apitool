...
class TaobaoTbkCouponTemporaryConvertMaterialDto {
    ...
    public function getTopnInfo() : TaobaoTbkCouponTemporaryConvertStepRateDto{
        return $this->topn_info;
    }

    public function setTopnInfo(TaobaoTbkCouponTemporaryConvertStepRateDto $topnInfo){
        $this->topn_info = $topnInfo;
    }

    public function getMiniProgram() : TaobaoTbkCouponTemporaryConvertMiniProgramDto{
        return $this->mini_program;
    }

    public function setMiniProgram(TaobaoTbkCouponTemporaryConvertMiniProgramDto $miniProgram){
